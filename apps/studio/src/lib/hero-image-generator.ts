...
const STYLE_BY_VARIANT: Record<DesignVariant, string> = {
  ...
  minimal:
    '純白に近い背景に、ごく淡いグレーの幾何学的な面と細い線だけで構成された静謐でミニマルな抽象背景。余白を大きく、要素は最小限',
  editorial:
    '紙面のような落ち着いた白背景に、太い罫線と大胆な色面が構成的に配置されたエディトリアルデザイン風の抽象背景。知的で構築的な印象',
  craft:
    'クラフト紙のような温かい質感の背景に、木目・織物・手仕事を思わせる素朴なテクスチャの抽象表現。実直で誠実な印象',
};
